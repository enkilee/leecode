 ...
 * @LastEditTime: 2020-03-17 11:24:27
...
int countCharacters(vector<string> &words, string chars,vector<string> &wordres) 
{
...
int main()
{
    ...
    string test="atach";
    int res=countCharacters(words,test,wordres);
    cout<<"result is : "<<res<<endl;
    cout<<"the "<<res<<" word is :"<<endl;
    for(auto word :wordres)
    {
        cout<<word<<endl;
    }
    return 0;
